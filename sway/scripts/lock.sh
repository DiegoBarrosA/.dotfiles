...
swaylock -i /home/tsuneko/Pictures/Landscape/lock.jpg --indicator-y-position 980 --indicator-x-position 100 --key-hl-color 00ff6f --ring-clear-color ff3000 --font Iosevka \
